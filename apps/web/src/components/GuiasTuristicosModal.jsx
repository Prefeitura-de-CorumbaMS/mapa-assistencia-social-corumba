...
const GuiasTuristicosModal = ({ visible, onClose }) => {
  ...
  const handleWhatsAppClick = (whatsapp, nome) => {
    ...
    const mensagem = encodeURIComponent(`Olá ${nome}, encontrei seu contato no Mapa da Assistência Social de Corumbá. Gostaria de obter informações sobre os serviços de assistência social que você oferece.`);
      ...
      title={
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <Title level={4} style={{ margin: 0, color: '#1890ff' }}>
            Serviços de Assistência Social de Corumbá
          </Title>
        </div>
      }
      open={visible}
    ...
    >
      {isLoading ? (
          ...
          <div style={{ marginTop: '16px', color: '#666' }}>
            Carregando serviços de assistência social...
          </div>
        </div>
      ) : guias.length === 0 ? (
        <Empty
          description="Nenhum serviço de assistência social disponível no momento"
        ...
        <>
          <div style={{
            ...
            <Text style={{ color: 'white', fontSize: '14px' }}>
              ✨ Encontre serviços, programas e atendimentos de Assistência Social em Corumbá.
